...
# # Create all the tables in the database, only required when creating the database
db.create_all()
...
def register():
    ...
    if form.validate_on_submit():
        ...
        hashed_and_salted_passwd = generate_password_hash(form.password.data, method='pbkdf2:sha256',
                                                          salt_length=8)
        new_user = User(
            email=email,
